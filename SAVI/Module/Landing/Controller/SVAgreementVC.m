...
//  SAVI
//
//  Created by Sorgle on 17/4/28.
//  Copyright © 2017年 Sorgle. All rights reserved.
//

#import "SVAgreementVC.h"

@interface SVAgreementVC ()

@property (nonatomic,strong) UIWebView *webView;

@end

@implementation SVAgreementVC
...
//    [self.webView loadData:data MIMEType:respnose.MIMEType textEncodingName:@"UTF8" baseURL:nil];
     //创建webveiw
    // 获取路径
    if ([self.pathName isEqualToString:@"service"]) {
...
//    self.navigationController.navigationBar.barTintColor = [UIColor whiteColor];
    ...
    if (@available(iOS 15.0, *)) {
         ...
         //  appperance.backgroundColor = [UIColor whiteColor];
           [appperance setBackgroundImage:[UIImage new]];
