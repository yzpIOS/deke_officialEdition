...
//https://itunes.apple.com/us/app/德客会员管理收银软件进销存/id1128257396?l=zh&ls=1&mt=8
- (void)updateVersion
{
    NSString *str = [NSString stringWithFormat:@"https://itunes.apple.com/cn/app/de-ke/id%@?mt=8", APP_ID];
