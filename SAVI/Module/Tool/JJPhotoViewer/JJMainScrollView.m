...
@property (nonatomic,strong) JJOneScrollView *oneScroll;
@end
...
-(void)setPhotoData:(NSArray *)photoArr Type:(JJPhotoViewerType)type
{
  ...
  //  NSMutableArray *imageArray = [NSMutableArray array];
    ...
    for (int i = 0; i < photoArr.count ; i ++)
    {
        ...
        oneScroll.selectNumber = self.selectNumber;
        self.oneScroll = oneScroll;
     ...
     //   [imageArray addObject:photo.imageView.image];
  ...
  //  self.oneScroll.ImageArray = imageArray;
