...
#import "SVTodaySalesVC.h"
#import "SVYesterdaySalesVC.h"
#import "SVWeekSalesVC.h"
#import "SVDateSalesVC.h"


//#import "SVFourButtonView.h"

@interface SVSalesListVC ()<UIScrollViewDelegate>
...
//    self.navigationItem.titleView = title;
    self.navigationItem.title = @"查询销售";
    //适配ios11偏移问题
...
- (void)setUpChildViewController {
    ...
    SVTodaySalesVC *firstVC = [[SVTodaySalesVC alloc] init];
    [self addChildViewController:firstVC];
    
    SVYesterdaySalesVC *secondVC = [[SVYesterdaySalesVC alloc] init];
    [self addChildViewController:secondVC];
    
    SVWeekSalesVC *thirdVC = [[SVWeekSalesVC alloc] init];
    [self addChildViewController:thirdVC];
    
    SVDateSalesVC *fourthVC = [[SVDateSalesVC alloc] init];
