...
@implementation SVReturnGoodsListVC
...
//    #pragma mark - 返回数组
//     self.listVC.selectModelBlock = ^(NSMutableArray *selectArray) {
...
- (void)segmentClick:(UISegmentedControl *)segment{
    ...
    if (segment.selectedSegmentIndex == 0) {
        ...
        self.listVC.view.frame = CGRectMake(0, 0, ScreenW, ScreenH - BottomHeight - 60-TopHeight);
        [self.lbxScanVC stopScan];
        [self.view addSubview:self.listVC.view];
        
        
    } else if (segment.selectedSegmentIndex == 1) {
        self.lbxScanVC.view.frame = CGRectMake(0, 0, ScreenW, ScreenH - BottomHeight - 60-TopHeight);
