...
//  SAVI
//
//  Created by Sorgle on 2017/7/24.
...
@interface SVTodyAnalysisVC ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource>
//全局
...
@property (nonatomic, strong) NSArray *items3;//图形数据
...
@implementation SVTodyAnalysisVC
...
- (void)viewDidLoad {
    ...
    self.todyScrollView.contentSize = CGSizeMake(0, 1983);
    ...
    [self setUpFiveViewWithType:1];
    //商品销售排行type      1 今天，2 昨天，3本月 4 日期筛选（ 填写开始日期和结束日期），5本周，6上周
    [self setUpSixViewWithType:1];
    
    // 求毛利润
    [self GrossProfitWith:0];
    
    //数据请求      //每日帐单      day:0=今天 -1昨天 7本周 -2=自定义
    //[self getSmartAnalysetWithID:2 date:@"2017-08-19" date2:@"2017-08-19" type:0];
    [self getSmartAnalysetWithType:0];
   // [self setUpTwoViewWithType:0];
}
// 求毛利润
- (void)GrossProfitWith:(NSInteger)type{
    [SVUserManager loadUserInfo];
    NSString *token = [SVUserManager shareInstance].access_token;
     NSString *bURL=[URLhead stringByAppendingFormat:@"/intelligent/GetProductAnalysis_new?key=%@&day=%li",token,(long)type];
    [[SVSaviTool sharedSaviTool] GET:bURL parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
         ...
         NSLog(@"9999dic = %@",dic);
        NSDictionary *valuesDic = [dic dictionaryForKeySafe:@"values"];
         self.V1labelD3.text = [NSString stringWithFormat:@"%.2f",[valuesDic[@"sv_p_originalprice"] doubleValue]];
       //  [MBProgressHUD hideHUDForView:self.view animated:YES];

//        responseObject = [responseObject stringByReplacingOccurrencesOfString:@":null" withString:@":\"\""];
//        NSString *str = [responseObject stringByReplacingOccurrencesOfString:@"<null>" withString:@""];
...
//-(void)getSmartAnalysetWithID:(NSInteger)ID date:(NSString *)date date2:(NSString *)date2 type:(NSInteger)type{
#pragma mark - 数据请求
-(void)getSmartAnalysetWithType:(NSInteger)type{
    
    [SVUserManager loadUserInfo];
    NSString *token = [SVUserManager shareInstance].access_token;
    
    //每日帐单      day:0=今天 -1昨天 7本周 -2=自定义
    //    NSString *bURL=[URLhead stringByAppendingFormat:@"/intelligent/mrdzd?key=%@&day=%li&beginDate=%@&endDate=%@",token,(long)type,date,date2];
    NSString *bURL=[URLhead stringByAppendingFormat:@"/intelligent/mrdzd?key=%@&day=%li",token,(long)type];
    [[SVSaviTool sharedSaviTool] GET:bURL parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSLog(@"今日bURL = %@",bURL);
//       NSString *str = [responseObject stringByReplacingOccurrencesOfString:@"<null>" withString:@""];
//         NSLog(@"今日str = %@",str);
...
//        self.V1labelD3.text = [NSString stringWithFormat:@"%.2f",[valuesDic[@"profit"] doubleValue]];
        ...
        if ([valuesDic[@"mreceivable"] floatValue] != 0){
            ...
            [self.colorArrM_3 addObject:colorJ];
        }
        
        // 处理会员数据
//        NSArray *membercustormArr = [NSArray array];
...
#pragma mark - 会员消费统计
        ...
        NSArray *custormArr = [NSArray array];
        custormArr = valuesDic[@"freeSalesCustormPayment"];
...
#pragma mark -- V1
-(void)setUpOneView{
    UIView *V1 = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenW, 248)];
    V1.backgroundColor = navigationBackgroundColor;
    [self.todyScrollView addSubview:V1];
    
    UIImageView *image = [[UIImageView alloc]initWithFrame:CGRectMake(0, 30, ScreenW, 218)];
    image.image = [UIImage imageNamed:@"AnalysisBackground"];
    [V1 addSubview:image];
    
    self.V1labelA3 = [[UILabel alloc]initWithFrame:CGRectMake(0, 70, ScreenW, 30)];
    //    label1.text = @"10300";
    ...
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(0, 100, ScreenW, 20)];
    label2.text = @"综合总收入(元)";
    ...
    self.V1labelB3 = [[UILabel alloc]initWithFrame:CGRectMake(0, 140, ScreenW/3, 20)];
    ...
    UILabel *label4 = [[UILabel alloc]initWithFrame:CGRectMake(0, 160, ScreenW/3, 20)];
    label4.text = @"新增会员(位)";
    ...
    self.V1labelC3 = [[UILabel alloc]initWithFrame:CGRectMake(ScreenW/3*1, 140, ScreenW/3, 20)];
    //    label5.text = @"35";
    ...
    UILabel *label6 = [[UILabel alloc]initWithFrame:CGRectMake(ScreenW/3*1, 160, ScreenW/3, 20)];
    label6.text = @"订单数(笔)";
    ...
    self.V1labelD3 = [[UILabel alloc]initWithFrame:CGRectMake(ScreenW/3*2, 140, ScreenW/3, 20)];
    //    label7.text = @"15.06";
    ...
    UILabel *label8 = [[UILabel alloc]initWithFrame:CGRectMake(ScreenW/3*2, 160, ScreenW/3, 20)];
    label8.text = @"毛利润(元)";
...
-(void)setUpThreeView{
    self.V3 = [[UIView alloc]initWithFrame:CGRectMake(0, 248, ScreenW, 223)];
...
- (void)setUpFiveView{
    self.V5 = [[UIView alloc]initWithFrame:CGRectMake(0, 471, ScreenW, 223)];
...
- (void)setUpTwoView{
    self.V2 = [[UIView alloc]initWithFrame:CGRectMake(0, 694, ScreenW, 223)];
...
-(void)setUpFourView{
    self.V4 = [[UIView alloc]initWithFrame:CGRectMake(0, 927, ScreenW, 200)];
...
- (void)setUpSixView{
    self.V6 = [[UIView alloc]initWithFrame:CGRectMake(0, 1127, ScreenW, 200)];
...
-(void)setUpFiveViewWithType:(NSInteger)type{
    UIView *V5 = [[UIView alloc]initWithFrame:CGRectMake(0, 1327, ScreenW, 323)];
    ...
    NSString *cURL=[URLhead stringByAppendingFormat:@"/intelligent/getMemberPagelist?key=%@&type=%li",token,(long)type];
...
-(void)setUpSixViewWithType:(NSInteger)type{
    UIView *V6 = [[UIView alloc]initWithFrame:CGRectMake(0, 1660, ScreenW, 323)];
