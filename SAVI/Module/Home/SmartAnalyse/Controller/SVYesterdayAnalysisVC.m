...
@interface SVYesterdayAnalysisVC ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource>
//全局
...
@implementation SVYesterdayAnalysisVC
...
#pragma mark - 会员消费统计
        ...
        //        }
        // 会员总额
        self.V3sumlabel.text = [NSString stringWithFormat:@"%.2f", [valuesDic[@"hy_receivable"] floatValue]];
