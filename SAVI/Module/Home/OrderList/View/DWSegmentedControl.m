...
-(void)setUpUI{
    ...
    self.layer.borderColor = (self.selectedViewColor?self.selectedViewColor:navigationBackgroundColor).CGColor;
    ...
    for (int i = 0;i<self.titles.count; i++) {
        ...
        titleLb.textColor = self.normalLabelColor?self.normalLabelColor:navigationBackgroundColor;
    ...
    _bgView.backgroundColor = self.selectedViewColor?self.selectedViewColor:navigationBackgroundColor;
