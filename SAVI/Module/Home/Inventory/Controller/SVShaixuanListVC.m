...
@interface SVShaixuanListVC ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation SVShaixuanListVC
...
-(void)setupRefresh{
    ...
    [self loadDataDay:4 Page:self.page pageSize:10 dt1:self.startTime dt2:self.endTime];
    /**
     下拉刷新
     */
...
- (void)loadDataDay:(NSInteger)day Page:(NSInteger)page pageSize:(NSInteger)pageSize dt1:(NSString *)dt1 dt2:(NSString *)dt2{
    ...
    NSString *urlStr = [URLhead stringByAppendingFormat:@"/api/Repertory/GetAllStoreStockCheckRecordInfo?key=%@&day=%li&page=%li&pageSize=%li&dt1=%@&dt2=%@&getdetail=true&getdate=true",[SVUserManager shareInstance].access_token,day,page,pageSize,dt1,[NSString stringWithFormat:@"%@ 23:59:59",dt2]];
