...
//  SAVI
//
//  Created by Sorgle on 2017/9/25.
...
@interface SVTodyPayVC ()<UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    [self getThreeSourcesWithBeginDate:date endDate:date page:1 pagesize:10];
...
-(void)getThreeSourcesWithBeginDate:(NSString *)beginDate endDate:(NSString *)endDate page:(NSInteger)page pagesize:(NSInteger)pagesize{
    
    [SVUserManager loadUserInfo];
    NSString *sURL=[URLhead stringByAppendingFormat:@"/api/Payment/GetPaymentInfosByType?key=%@&beginDate=%@&endDate=%@&page=%li&pagesize=%li&day=%i",[SVUserManager shareInstance].access_token,beginDate,endDate,(long)page,(long)pagesize,1];
