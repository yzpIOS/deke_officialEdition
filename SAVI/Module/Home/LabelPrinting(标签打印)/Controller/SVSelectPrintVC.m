...
-(NSData *)tscCommandModel:(SVWaresListModel *)model{
    if (model.sv_p_artno.length >= 17 || model.sv_p_barcode.length >= 17) {
        ...
        if ([[SVUserManager shareInstance].sv_uit_cache_name isEqualToString:@"cache_name_clothing_and_shoes"]){
            [command addTextwithX:0 withY:50 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:[NSString stringWithFormat:@"款号:%@",model.sv_p_barcode]];
        }else{
        ...
        NSString *sv_p_specsStr = [model.sv_p_specs stringByReplacingOccurrencesOfString:@"\n" withString:@""]; //
        if ([model.sv_p_specs containsString:@"\n"]) {
            [command addTextwithX:0 withY:200 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:sv_p_specsStr];
        }else{
        ...
        [SVUserManager loadUserInfo];
        if ([[SVUserManager shareInstance].sv_uit_cache_name isEqualToString:@"cache_name_clothing_and_shoes"]){
            [command addTextwithX:30 withY:50 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:[NSString stringWithFormat:@"款号:%@",model.sv_p_barcode]];
        }else{
      ...
      //  [command add1DBarcode:30 :70 :@"CODE128" :80 :1 :0 :2 :6 :model.sv_p_barcode];
        ...
        if (!kStringIsEmpty(model.sv_p_specs)) {
            if ([model.sv_p_specs containsString:@"\n"]) {
              //  model.sv_p_specs re
                NSString *sv_p_specsStr = [model.sv_p_specs stringByReplacingOccurrencesOfString:@"\n" withString:@""]; //
                [command addTextwithX:30 withY:200 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:sv_p_specsStr];
            }else{
...
- (NSData *)firstTscCommandModel:(SVWaresListModel *)model{
    ...
    if ([model.sv_p_specs containsString:@"\n"]) {
        NSString *sv_p_specsStr = [model.sv_p_specs stringByReplacingOccurrencesOfString:@"\n" withString:@""]; //
        [command addTextwithX:64 withY:165 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:sv_p_specsStr];
    }else{
...
-(NSData *)secondTscCommandModel:(SVWaresListModel *)model{
    ...
    [command addQueryPrinterStatus:ON];
    [command addCls];
    [command addTextwithX:10 withY:10 withFont:@"TSS24.BF2" withRotation:0 withXscal:1.3 withYscal:1 withText:model.sv_p_name];
    //    [command addTextwithX:30 withY:40 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:[NSString stringWithFormat:@"条码:%@",model.sv_p_artno]];
    if (kStringIsEmpty(model.sv_p_artno)) {

 
         [command add1DBarcode:10 :40 :@"CODE128" :55 :0 :0 :2 :6 :model.sv_p_barcode];
    }else{
         [command add1DBarcode:10 :40 :@"CODE128" :55 :0 :0 :2 :6 :model.sv_p_artno];
    }
    if ([model.sv_p_specs containsString:@"\n"]) {
        NSString *sv_p_specsStr = [model.sv_p_specs stringByReplacingOccurrencesOfString:@"\n" withString:@""]; //
        [command addTextwithX:10 withY:100 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:sv_p_specsStr];
    }else{
        [command addTextwithX:10 withY:100 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:model.sv_p_specs];
    }
   
    [command addTextwithX:10 withY:130 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:model.sv_p_barcode];

    if (model.sv_p_barcode.length <= 14) {
        [command addTextwithX:150 withY:130 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:[NSString stringWithFormat:@"￥%@",model.sv_p_unitprice]];
    }else{
        [command addTextwithX:150 withY:130 withFont:@"TSS24.BF2" withRotation:0 withXscal:1 withYscal:1 withText:[NSString stringWithFormat:@"￥%@",model.sv_p_unitprice]];
    }
...
-(NSData *)threeTscCommandModel:(SVWaresListModel *)model{
    ...
    [SVUserManager loadUserInfo];
    if ([[SVUserManager shareInstance].sv_uit_cache_name isEqualToString:@"cache_name_clothing_and_shoes"]){
        [command addTextwithX:15 withY:190 withFont:@"TSS24.BF2" withRotation:0 withXscal:1.3 withYscal:1.3 withText:[NSString stringWithFormat:@"款号：%@",model.sv_p_barcode]];
    }else{
    ...
    if ([model.sv_p_specs containsString:@"\n"]) {
        NSString *sv_p_specsStr = [model.sv_p_specs stringByReplacingOccurrencesOfString:@"\n" withString:@""]; //
        [command addTextwithX:15 withY:240 withFont:@"TSS24.BF2" withRotation:0 withXscal:1.3 withYscal:1.3 withText:[NSString stringWithFormat:@"规格：%@",sv_p_specsStr]];
    }else{
